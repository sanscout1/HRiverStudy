package Java_Lecture.About_oop.day2.basic.classEx.sec03.exam01;
...
public class CarExample {
	public static void main(String[] args) {
		...
		//Java_Lecture.About_class_basic.Car 타입을 저장할 수 있는 myCarArray
		...
		car1.speed=100;
		car1.engine=true;
		//Java_Lecture.About_class_basic.Car 객체의 필드값 읽기
